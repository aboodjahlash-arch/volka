...
class Settings(BaseSettings):
    ...
    # Default: MiniMax-M3 from OpenRouter as the primary LLM
    api_key: str | None = None
    api_base: str | None = "https://openrouter.ai/api/v1"

    # Model configuration
    # Primary model: minimax/minimax-m3 via OpenRouter
    model_name: str = "minimax/minimax-m3"
    model_provider: str = "openai"  # OpenRouter is OpenAI-compatible
    temperature: float = 0.7
    max_tokens: int = 2000
    
    # MongoDB configuration
    mongodb_uri: str = "mongodb://mongodb:27017"
    mongodb_database: str = "volk_ai"
    ...
    sandbox_image: str = "volk-ai-sandbox:latest"
    sandbox_name_prefix: str | None = None
    sandbox_ttl_minutes: int | None = 30
    sandbox_network: str | None = "volk-ai-network"  # Docker network bridge name
    ...
    github_repository_url: str = "https://github.com/volk-ai/volk-ai"
    ...
    claw_image: str = "volk-ai/volk-ai-claw"
    claw_name_prefix: str = "volk-ai-claw"
    claw_ttl_seconds: int = 3600
    claw_network: str | None = "volk-ai-network"  # Docker network bridge name for claw containers
    ...
    volk_ai_api_base_url: str = "http://backend:8000"  # URL of this backend accessible from volk-ai containers
