...
async def lifespan(app: FastAPI):
    ...
    logger.info("Application startup - VOLK AI Agent initializing")
    ...
    try:
        ...
        logger.info("Application shutdown - VOLK AI Agent terminating")
...
app = FastAPI(title="VOLK AI Agent", lifespan=lifespan)
