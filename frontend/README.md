...
This is the frontend for VOLK AI, an AI agent specialized in cybersecurity and ethical hacking. Built with Vue 3 + TypeScript + Vite.
...
```bash
# Build Docker image
docker build -t volk-ai-frontend .

# Run container (map container port 80 to host port 8080)
docker run -d -p 8080:80 volk-ai-frontend
