export default {
  ...
  'Friday': 'Fri',
  'Saturday': 'Sat',
  'Omar Computer': 'VOLK AI Computer',
  'Omar is using': 'VOLK AI is using',
  'Jump to live': 'Jump to live',
  'Failed to load file content': 'Failed to load file content',
  'Give Omar a task to work on...': 'Give VOLK AI a task to work on...',
  // Shell tools
  ...
  'Archive': 'Archive',
  // Login/Register Page
  'Login to Omar': 'Login to VOLK AI',
  'Register to Omar': 'Register to VOLK AI',
  'Full Name': 'Full Name',
  'Email': 'Email',
  'Password': 'Password',
  ...
  'Registration successful! Welcome to Omar': 'Registration successful! Welcome to VOLK AI',
  ...
  'You are viewing a completed Omar task. Replay will start automatically in {countdown} seconds.': 'You are viewing a completed VOLK AI task. Replay will start automatically in {countdown} seconds.',
  // Claw Page
  ...
  'Chat Freely via Omar': 'Chat Freely via VOLK AI',
  ...
  'Create Omar Claw': 'Create VOLK AI Claw',
  'One-click OpenClaw deployment by Omar': 'One-click OpenClaw deployment by VOLK AI',
  'Creating...': 'Creating...',
  'Create': 'Create',
...
} // This is appended - we'll handle it properly
