export default {
  ...
  'Friday': '周五',
  'Saturday': '周六',
  'Omar Computer': 'VOLK AI 的电脑',
  'Omar is using': 'VOLK AI 正在使用',
  'Jump to live': '跳到实时',
  'Failed to load file content': '加载文件内容失败',
  'Give Omar a task to work on...': '给 VOLK AI 一个任务...',
  // Shell tools
  ...
  'Archive': '压缩包',
  // Login/Register Page
  'Login to Omar': '登录 VOLK AI',
  'Register to Omar': '注册 VOLK AI',
  'Full Name': '姓名',
  'Email': '邮箱',
  'Password': '密码',
  ...
  'Registration successful! Welcome to Omar': '注册成功！欢迎使用 VOLK AI',
  ...
  'You are viewing a completed Omar task. Replay will start automatically in {countdown} seconds.': '您正在查看一个已完成的 VOLK AI 任务。回放将在 {countdown} 秒后自动开始。',
  // Claw Page
  ...
  'Chat Freely via Omar': '通过 VOLK AI 自由对话',
  ...
  'Get Started': '立即开始',
  'Create Omar Claw': '创建 VOLK AI Claw',
  'One-click OpenClaw deployment by Omar': 'VOLK AI 帮你一键部署的 OpenClaw',
  'Creating...': '创建中...',
  'Create': '创建',
