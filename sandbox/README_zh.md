...
VOLK AI 沙盒是一个基于Docker容器的隔离执行环境，为 VOLK AI Agent（专注于网络安全与道德黑客）提供安全的 Shell 命令执行、文件操作和浏览器自动化能力。该服务通过 FastAPI 提供API接口，支持与后端服务交互。

## 技术架构

沙盒服务集成多项技术，提供 VOLK AI Agent 操作环境：
